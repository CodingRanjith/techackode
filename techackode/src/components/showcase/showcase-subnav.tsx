...
import { showcaseNavItems } from '@/data/showcase'
import { Container } from '@/components/common/container'
import { cn } from '@/lib/utils'

type ShowcaseSubnavProps = {
  theme?: 'default' | 'home'
}

export function ShowcaseSubnav({ theme = 'default' }: ShowcaseSubnavProps) {
